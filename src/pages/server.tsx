...
export default function ServerSidePage({ session }: { session: Session }) {
    ...
    return (
        <Layout>
            ...
            <p>
                This page uses the <strong>unstable_getServerSession()</strong>{' '}
                method in <strong>unstable_getServerSideProps()</strong>.
            </p>
            <p>
                Using <strong>unstable_getServerSession()</strong> in{' '}
                <strong>unstable_getServerSideProps()</strong> is the
